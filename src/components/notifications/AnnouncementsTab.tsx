...
import { getNotifications, Notification, markAsRead, deleteNotification, markAllAsRead } from '@/services/notificationService';
...
export default function AnnouncementsTab() {
  ...
  const handleMarkAllAsRead = async () => {
    try {
      ...
      showToast(t('notifications.markAllReadSuccess') || '已全部标记为已读', 'success');
    } catch (error) {
      console.error('Failed to mark all as read:', error);
      showToast(t('notifications.markAllReadFailed') || '操作失败', 'error');
    }
  };
          ...
          >
            ...
            >
              <h3 className={styles.notificationTitle}>
                {notification.title || t('notifications.announcement')}
              </h3>
